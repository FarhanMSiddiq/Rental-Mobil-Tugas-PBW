	...
	public function tambah_rental_aksi(){
		...
		if(empty($this->session->userdata('role_id'))){
			$this->session->set_flashdata('pesan','
				<div class="alert alert-danger dark alert-dismissible fade show" role="alert">  Silakan Login Untuk Melanjutkan Transaksi
		...
		$this->session->set_flashdata('pesan','
				<div class="alert alert-primary dark alert-dismissible fade show" role="alert"> Transaksi Berhasil, Silakan Checkout
					<button class="btn-close" type="button" data-bs-dismiss="alert" aria-label="Close"></button>
				</div>');
