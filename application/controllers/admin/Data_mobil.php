...
class Data_mobil extends CI_Controller{
	...
	public function tambah_mobil_aksi(){
		...
		if($this->form_validation->run() == FALSE){
			...
			$this->session->set_flashdata('pesan',
				'<div class="alert alert-primary dark alert-dismissible fade show" role="alert"><i data-feather="alert-circle"></i>
	...
	public function delete_mobil($id){
		...
		$this->session->set_flashdata('pesan','
				<div class="alert alert-danger dark alert-dismissible fade show" role="alert"><i data-feather="alert-circle"></i>
